  ...
  enterprisePage: {
    ...
    ssr: {
      ...
      items: [
        {
          title: '合同中心',
          desc: '基于Apache Shiro实现授权和访问控制日志及审计管理'
        },
        {
          title: '应用系统的访问控制',
          desc: '用户身份的鉴别/用户权限控制'
        ...
        {
          title: '应用系数据加密',
          desc: '数据传输加密/数据存放加密/密钥管理'
        },
        {
          title: '数据应用安全',
          desc: '数据报文加密/数据报文鉴别/数据校验'
        },
        {
          title: '系统可靠性',
          desc: '系统强兼容能力/系统高稳定性系统良好扩展性/系统优秀的可维护性'
        },
        {
          title: '应用系统的使用安全',
          desc: '安全告警/备份与恢复'
    ...
    bmpProcessNodeTracking: {
      title: '业务综合管理平台 全流程节点跟踪',
      items: [
        {
          title: '合同中心',
          desc: '商机管理、阶段管理、合同关联信息、收款计划、跟催流程、附件管理、预警管理'
        },
        {
          title: '客户、供应商看板',
          desc: '供应商基本信息管理、历史合作项目、评价信息、评审信息、供应商资质管理'
        },
        {
          title: '项目流程管理',
          desc: '项目信息管理、里程碑流程管理、验收管理、维保续签管理'
        },
        {
          title: '业务、采购流程',
          desc: '销售方案评审、信息变更、付款流程管理、发票管理、资金管理'
        },
        {
          title: '报表监控',
          desc: '商机线索报表、项目进度报表、资金报表、收益报表'
        }
      ]
    },
    unitedTechnologyInnovation: {
      ...
      items: [
        [
          {
            title: 'AI 能力平台',
            desc: 'AI “能”，引擎核心能力<br>AI “学”，半监督自助训练'
          },
          {
            title: '数据智能化',
            desc: '智能分析:<br>AI “灵”，精准用户画像<br>精准营销：<br>AI “销”，精准营销'
          }
        ],
        {
          title: '工具智能化',
          desc: '智能质检：<br>AI “听”，质检分析自动化<br><br>智能外呼：<br>AI “说”，机器人客服<br><br>智能辅助：<br>AI “看”，实时座席助手<br><br>智能培训：<br>AI “练”，人机智能对练'
        },
        {
          title: 'AI 数据中台',
          desc: 'AI “智”<br>智能数据 BI 平台<br><br>智能知识库<br>AI “慧”<br>智能化知识服务平台'
        }
      ]
    }
  },
