<template>
  <div :class="cls">
    ...
    <UiRowCard fixed-layout :box-class="`${cls}_banner_box`" :title="obj.bannerTitle">
      <template #bg>
        <img src="/images/video/banner1.jpg" alt="">
      </template>
    </UiRowCard>
    <!-- 人像美颜 -->
    ...
    <UiRowCard is-right v-bind="obj.videoFilter" :box-style="{left: '60%'}">
      <template #bg>
        <img src="/images/video/banner3.jpg" alt="">
      </template>
    ...
    <UiRowCard is-right v-bind="obj.qualityMms" :box-class="`${cls}_qmms_box`">
      <template #bg>
        <img src="/images/video/banner10.jpg" alt="">
      </template>
    </UiRowCard>
    <!-- 5G 智能视频客服业务系统 -->
    <UiRowCard v-bind="obj.smartVideoCss">
      <template #bg>
        <img src="/images/video/banner11.jpg" alt="">
      </template>
    </UiRowCard>
    <!-- 高清视频会议系统 -->
    <UiRowCard is-right v-bind="obj.conferenceSystem" :box-style="{left: '60%'}">
      <template #bg>
        <img src="/images/video/banner12.jpg" alt="">
      </template>
    </UiRowCard>
    <!-- 使用案例 -->
